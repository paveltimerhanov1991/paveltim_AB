			...
			<div class="fm-edit-content">
					...
					<div class="wdform_column ui-sortable" id="add_field_cont">
						...
						<div id="add_field" class="ui-sortable-handle">
							...
							<div class="add-new-button button-primary" onclick="if (fm_check_something_really_important()) return; popup_ready(); Enable(); return false;" title="<?php _e('Drag icon to the form or click here to add a field.', WDFMInstance(self::PLUGIN)->prefix); ?>">
