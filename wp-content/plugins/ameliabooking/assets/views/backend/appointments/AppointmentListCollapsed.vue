    ...
    <div class="am-appointment-details">
      <el-row>
        ...
        >
          ...
          <!-- Customer Phone -->
          <div v-if="getCustomerInfo(app.bookings[key]) && getCustomerInfo(app.bookings[key]).phone && $root.settings.role !== 'customer'"
          ...
          <div v-for="(customField, customFieldId) in JSON.parse(app.bookings[key].customFields)"
               v-if="showCustomField(customField.value)"
               class="am-appointment-collapsed-field"
          >
            ...
            <el-col :sm="7">
              <p class="am-value">
                {{ getCustomFieldValue(customField.value) }}
              </p>
            </el-col>
