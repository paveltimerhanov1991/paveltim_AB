      ...
      <el-form :model="settings" ref="settings" :rules="rules" label-position="top" @submit.prevent="onSubmit">
        ...
        <el-collapse v-model="payPalCollapse" v-popover:payPalPop :class="{'am-lite-disabled': ($root.isLite)}">
          <el-collapse-item class="am-setting-box" name="payPal">
            <!-- PayPal Title -->
            <template slot="title">
              <img class="svg" :src="this.$root.getUrl + 'public/img/payments/paypal-light.svg'">
            ...
            >
              <el-input v-model="settings.payPal.liveApiClientId" auto-complete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item
                ...
                v-show="settings.payPal.enabled === true && settings.payPal.sandboxMode === false"
            >
              <el-input v-model="settings.payPal.liveApiSecret" auto-complete="off"></el-input>
            </el-form-item>
            ...
            >
              <el-input v-model="settings.payPal.testApiClientId" auto-complete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item
                ...
                v-show="settings.payPal.enabled === true && settings.payPal.sandboxMode === true"
            >
              <el-input v-model="settings.payPal.testApiSecret" auto-complete="off"></el-input>
            </el-form-item>
        ...
        <el-collapse v-model="stripeCollapse" v-popover:stripePop :class="{'am-lite-disabled': ($root.isLite)}">
          <el-collapse-item class="am-setting-box" name="stripe">
            ...
            <!-- Stripe Title -->
            <template slot="title">
              <img class="svg" :src="this.$root.getUrl + 'public/img/payments/stripe.svg'">
            ...
            >
              <el-input v-model="settings.stripe.livePublishableKey" auto-complete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item
                ...
                v-show="settings.stripe.enabled === true && settings.stripe.testMode === false"
            >
              <el-input v-model="settings.stripe.liveSecretKey" auto-complete="off"></el-input>
            </el-form-item>
            ...
            >
              <el-input v-model="settings.stripe.testPublishableKey" auto-complete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item
                ...
                v-show="settings.stripe.enabled === true && settings.stripe.testMode === true"
            >
              <el-input v-model="settings.stripe.testSecretKey" auto-complete="off"></el-input>
            </el-form-item>
