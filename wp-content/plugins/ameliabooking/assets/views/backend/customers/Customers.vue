  ...
  <div class="am-wrap">
    <div id="am-customers" class="am-body">
      ...
      <div class="am-empty-state am-section"
        ...
        <p>{{ $root.labels.click_add_customers }}</p>
      </div>

      <!-- Customers -->
      <div
          v-show="fetched && (customers.length !== 0 || customers.length === 0 && filterApplied || !fetchedFiltered)">

        <!-- Filter -->
        <el-popover :disabled="!$root.isLite" ref="filterPop" v-bind="$root.popLiteProps"><PopLite/></el-popover>
        <div class="am-customers-filter am-section" v-popover:filterPop>
        ...
        <!-- Customer List -->
        <div class="am-customers" v-show="fetchedFiltered && customers.length !== 0">
                      ...
                      <el-col :lg="12">
                        <el-row :gutter="10" class="am-customers-flex-row-middle-align">
                          ...
                          <el-col :lg="4" :sm="7" class="align-right">
                            <div @click.stop>
                              <el-button @click="showDialogEditCustomer(index)">{{ $root.labels.edit }}</el-button>
                            </div>
                          </el-col>
