    ...
    public function getFrontendSettings()
    {
        ...
        return [
            ...
            'general'        => [
                ...
                'automaticallyCreateCustomer'     => $this->getSetting('general', 'automaticallyCreateCustomer'),
                'allowConfigureSchedule'          => $this->getSetting('general', 'allowConfigureSchedule'),
                'allowWriteAppointments'          => $this->getSetting('general', 'allowWriteAppointments'),
                ...
                'inspectCustomerInfo'             => $this->getSetting('general', 'inspectCustomerInfo'),
            ],
            'googleCalendar' => [
